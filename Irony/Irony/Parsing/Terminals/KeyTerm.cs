...
namespace Irony.Parsing {
  ...
  public class KeyTerm : Terminal {
    ...
    public override void Init(GrammarData grammarData) {
      ...
      /* ## Editado para no sobreescribir prioridades establecidas manualmente  */
      if (Priority == TerminalPriority.Normal)
      {
      ...
      /* ## Fin editado para no sobreescribir prioridades establecidas manualmente  */
