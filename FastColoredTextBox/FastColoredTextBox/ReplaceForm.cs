...
namespace FastColoredTextBoxNS
{
    public partial class ReplaceForm : Form
    {
        ...
        private void btFindNext_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!Find(tbFind.Text))
                    MessageBox.Show(this, Texts.Texts.NotFound, Texts.Texts.FindAndReplace);
            }
            catch (Exception ex)
            {
                MessageBox.Show(this, ex.Message, Texts.Texts.FindAndReplace);
            }
        }
        ...
        private void ReplaceForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            this.tb.Focus();
            this.tb.OnSecondaryFormClosed(this);
        }
        ...
        private void btReplaceAll_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //
                tb.Invalidate();
                MessageBox.Show(string.Format(Texts.Texts.NOccurrencesReplaced, ranges.Count));
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
